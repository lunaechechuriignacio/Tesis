 ...
 *
 */
#define API_KEY "AIzaSyBVdr6FlCRrh2rhpBn698VxtJJwrIF1b1s"

/* 3. Define the user Email and password that already registerd or added in your project */
#define USER_EMAIL "proyectoesp32untref@gmail.com"
#define USER_PASSWORD "esp322022"

/* 4. If work with RTDB, define the RTDB URL */
#define DATABASE_URL "https://prueba-conexion-4396c-default-rtdb.firebaseio.com" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
